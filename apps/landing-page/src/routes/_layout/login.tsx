...
import { registerUrl, signinUrl } from "@/constants";

export const Route = createFileRoute("/_layout/login")({
  head: () => ({
    meta: createMetaTags({
      title: "Sign In | Typebot",
      description: "Sign in to your Typebot account to manage your chatbots.",
...
function RouteComponent() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // This is a landing/marketing page - form doesn't actually submit
    // In a real implementation, this would validate and submit to the auth endpoint
    console.log("Form would submit to auth endpoint");
  };
