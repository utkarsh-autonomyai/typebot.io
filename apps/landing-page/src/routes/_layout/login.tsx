...
import { TextLink, CtaButtonLink } from "@/components/link";
...
export const Route = createFileRoute("/_layout/login")({
  head: () => ({
    meta: createMetaTags({
      title: "Login | Typebot",
      description: "Sign in to your Typebot account to build and manage your chatbots.",
      ...
      <Card className="w-full max-w-md p-8">
        ...
        <form onSubmit={handleSubmit} className="mt-8 flex flex-col gap-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <TextLink to="/forgot-password" className="text-sm text-orange-9 hover:text-orange-10">
              Forgot password?
            </TextLink>
          </div>
        ...
        <p className="mt-6 text-center text-sm text-gray-11">
          ...
          <CtaButtonLink href={registerUrl} className="text-orange-9 hover:text-orange-10 font-medium inline p-0 h-auto bg-transparent hover:bg-transparent">
            Sign up
          </CtaButtonLink>
        </p>
      </Card>
